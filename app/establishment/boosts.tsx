...
const styles = StyleSheet.create({
  ...
  tabText: { color: Pastel.textMuted, fontSize: 12, fontFamily: Font.semiBold, includeFontPadding: false },
  tabTextActive: { color: "#fff", fontFamily: Font.extraBold, includeFontPadding: false },
  descBox: {
    backgroundColor: Pastel.tealSoft,
    borderRadius: 14, borderWidth: 1, borderColor: Pastel.teal,
    padding: 16, marginBottom: 20, gap: 6,
  },
  descTitle: { color: Pastel.text, fontSize: 15, fontFamily: Font.extraBold, includeFontPadding: false },
  descText: { color: Pastel.textMuted, fontSize: 13, lineHeight: 20, fontFamily: Font.regular, includeFontPadding: false },
  descEmphasis: { color: Pastel.teal, fontFamily: Font.extraBold },
  quotaRow: {
  ...
  quotaLabel: { color: Pastel.text, fontSize: 15, fontFamily: Font.extraBold, includeFontPadding: false },
  quotaSubLabel: { color: Pastel.textMuted, fontSize: 13, marginTop: 2, fontFamily: Font.regular, includeFontPadding: false },
  quotaBadge: { alignItems: "center" },
  quotaValue: { fontSize: 32, fontFamily: Font.display, lineHeight: 36, includeFontPadding: false },
  quotaValueUnit: { color: Pastel.textMuted, fontSize: 11, fontFamily: Font.semiBold, includeFontPadding: false },
  monthNav: {
    flexDirection: "row", justifyContent: "space-between",
    alignItems: "center", marginBottom: 12,
  },
  navArrow: { color: Pastel.text, fontSize: 28, paddingHorizontal: 12 },
  monthLabel: { color: Pastel.text, fontSize: 16, fontFamily: Font.extraBold, includeFontPadding: false },
  weekRow: { flexDirection: "row", marginBottom: 4 },
  weekDay: {
    flex: 1, textAlign: "center",
    color: Pastel.textMuted, fontSize: 12, fontFamily: Font.semiBold, includeFontPadding: false,
  },
  ...
  dayText: { color: Pastel.text, fontSize: 14, fontFamily: Font.semiBold, includeFontPadding: false },
  ...
  legendText: { color: Pastel.textMuted, fontSize: 12, fontFamily: Font.regular, includeFontPadding: false },
  errorBox: {
    marginTop: 12, padding: 12, borderRadius: 12,
    backgroundColor: "#FEE2E2", borderWidth: 1, borderColor: "#FECACA",
  },
  errorText: { color: RED, fontSize: 13, fontFamily: Font.semiBold, includeFontPadding: false },
  confirmBox: {
  ...
  confirmBoxDanger: { backgroundColor: "#FEF2F2", borderColor: "#FECACA" },
  confirmTitle: { color: Pastel.text, fontSize: 15, fontFamily: Font.extraBold, includeFontPadding: false },
  confirmSubtitle: { color: Pastel.textMuted, fontSize: 13, lineHeight: 19, fontFamily: Font.regular, includeFontPadding: false },
  ...
  confirmCancelText: { color: Pastel.text, fontFamily: Font.bold, fontSize: 14, includeFontPadding: false },
  confirmOk: {
    flex: 1, paddingVertical: 11, borderRadius: 12,
    backgroundColor: Pastel.primary, alignItems: "center",
  },
  confirmOkDanger: { backgroundColor: RED },
  confirmOkText: { color: "#fff", fontFamily: Font.bold, fontSize: 14, includeFontPadding: false },
  myBookings: { marginTop: 24 },
  myBookingsTitle: { color: Pastel.text, fontSize: 15, fontFamily: Font.extraBold, marginBottom: 12, includeFontPadding: false },
  bookingRow: {
    flexDirection: "row", justifyContent: "space-between",
    alignItems: "center", paddingVertical: 10,
    borderBottomWidth: 1, borderBottomColor: Pastel.border,
  },
  bookingDate: { color: Pastel.text, fontSize: 14, fontFamily: Font.semiBold, includeFontPadding: false },
  ...
  noAccessText: { color: Pastel.textMuted, fontSize: 14, textAlign: "center", lineHeight: 22, fontFamily: Font.regular, includeFontPadding: false },
  upgradeBtn: { backgroundColor: Pastel.teal, paddingVertical: 13, paddingHorizontal: 28, borderRadius: 14 },
  upgradeBtnText: { color: "#fff", fontFamily: Font.extraBold, fontSize: 14, includeFontPadding: false },
});
